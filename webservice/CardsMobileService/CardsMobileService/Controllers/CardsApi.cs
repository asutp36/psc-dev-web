...
namespace CardsMobileService.Controllers
{
    public class CardsApi
    {
        ...
        public int WriteIncrease(IncreaseFromChanger model) 
        {
            if (_model.Database.CanConnect())
            {
                ...
                try
                {
                    ...
                    _logger.LogDebug("command is: " + command);
                ...
                catch(Exception e)
                {
                    ...
                    _logger.LogError("ошибка записи. " + e.Message + Environment.NewLine + e.StackTrace);
        ...
        public int WriteNewCard(NewCardFromChanger model) 
        {
            if (_model.Database.CanConnect())
            {
                ...
                try
                {
                    ...
                    _logger.LogInformation("Добавлены Owner и Card. CardNum = " + model.cardNum);
        ...
        public List<string> GetCardsByPhone(string phone) 
        {
            ...
            List<Card> cards = _model.Cards.Where(c => c.Idowner == _model.Owners.Where(o => o.PhoneInt.Equals(formattedPhone.phoneInt)).First().Idowner).ToList();
        ...
        public TechCards GetTechCards()
        {
            ...
            List<Card> cards = _model.Cards.Where(c => !c.IdcardType.Equals(_model.CardTypes.Where(ct => ct.Code.Equals("client")).FirstOrDefault().IdcardType)).ToList();
